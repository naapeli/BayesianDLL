...
plt.tight_layout()
plt.savefig("Tests/bayesian_regression/polynomial_posteriors_with_NUTS.png")
...
plt.title("Posterior of σ")
plt.tight_layout()
plt.savefig("Tests/bayesian_regression/polynomial_trace_plots_with_NUTS.png")
...
plt.legend()
plt.tight_layout()
plt.savefig("Tests/bayesian_regression/polynomial_fit_with_NUTS.png")
